                                ...
                                case 'mlExtension':
                                    ...
                                    typescript_schema_1.visitClassConstructor(cc, {
                                        onImplement: function (impl) {
                                            if (typescript_schema_1.interfaceConstructorToString(impl.typeConstructor) === 'markscript-core/lib/server/extension:Extension') {
                                                isValid = true;
                                            }
                                        },
                                    ...
                                    var extensionModuleName = '_extensions-' + typescript_schema_1.classConstructorToString(cc).replace(/:/g, '-').replace(/\//g, '-');
                                ...
                                onMember: function (member) {
                                    return {
                                        onMemberDecorator: function (decorator) {
                                            switch (decorator.decoratorType.name) {
                                                case 'mlRuleSet':
                                                    if (member.type.primitiveTypeKind !== typescript_schema_1.PrimitiveTypeKind.STRING && !(member.type.typeKind === typescript_schema_1.TypeKind.FUNCTION && member.type.type.primitiveTypeKind === typescript_schema_1.PrimitiveTypeKind.STRING)) {
                                                ...
                                                case 'mlAlert':
                                                    ...
                                                    if (member.type.typeKind !== typescript_schema_1.TypeKind.FUNCTION || member.type.parameters.length !== 2) {
                                                ...
                                                case 'mlTask':
                                                    ...
                                                    if (member.type.typeKind !== typescript_schema_1.TypeKind.FUNCTION || member.type.parameters.length > 0) {
