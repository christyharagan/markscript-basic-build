...
function loadCode(baseDir, modulePath) {
...
function addExtensions(assetModel, baseDir, extensions) {
    if (!assetModel.extensions) {
        assetModel.extensions = {};
    }
    Object.keys(extensions).forEach(function (name) {
        var extensionCode = loadCode(baseDir, extensions[name]);
...
function addModules(assetModel, packageDir, baseDir, modulePaths) {
    if (!assetModel.modules) {
        assetModel.modules = {};
    }
    ...
    modulePaths.forEach(function (moduleToDeploy) {
        if (!assetModel.modules[moduleToDeploy]) {
            var moduleCode = loadCode(baseDir, moduleToDeploy);
